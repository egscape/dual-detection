...
This experiment was created using PsychoPy3 Experiment Builder (v2020.1.2),
    on Sat 12 Dec 2020 15:31:31 GMT
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/home/matteo/psychopy_local/dual-d-detection/dual-d-detection_lastrun.py',
...
for thisTrial_2 in trials_2:
    ...
    for thisTrial in trials:
        ...
        fixation.setSize((1*x_scale, 1*y_scale))
        ...
        for thisCorrect_D1 in correct_D1:
            ...
            #contrast_lvl = 10
            Tpath = 'stimuli/S/SCS{contrast}/{number}.bmp'.format(contrast=contrast_lvl,number=np.asscalar(np.random.randint(1,20,size=1)))
            fixation_2.setSize((1*x_scale, 1*y_scale))
        ...
        for thisWrong_D1 in wrong_D1:
            ...
            fixation_3.setSize((1*x_scale, 1*y_scale))
