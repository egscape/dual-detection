...
function fillerRoutineBegin(trials) {
  return function () {
    ...
    fillerComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function practice_message_0RoutineBegin(trials) {
  return function () {
    ...
    practice_message_0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function practice_correctLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  practice_correct.forEach(function() {
...
function practice_wrongLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  practice_wrong.forEach(function() {
...
function branchRoutineBegin(trials) {
  return function () {
    ...
    branchComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function practice_message_d1RoutineBegin(trials) {
  return function () {
    ...
    practice_message_d1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function d2_correctRoutineBegin(trials) {
  return function () {
    ...
    d2_correctComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function d2_wrongRoutineBegin(trials) {
  return function () {
    ...
    d2_wrongComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function practice_message_d2RoutineBegin(trials) {
  return function () {
    ...
    practice_message_d2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ready_goRoutineBegin(trials) {
  return function () {
    ...
    ready_goComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function adjust_contrastRoutineBegin(trials) {
  return function () {
    ...
    adjust_contrastComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
